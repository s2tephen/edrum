...
class SequencesControllerTest < ActionController::TestCase
  ...
  test "should create sequence" do
    assert_difference('Sequence.count') do
      post :create, sequence: { artist: @sequence.artist, default_bpm: @sequence.default_bpm, meter_bottom: @sequence.meter_bottom, meter_top: @sequence.meter_top, time: @sequence.time, title: @sequence.title }
    end
  ...
  test "should update sequence" do
    patch :update, id: @sequence, sequence: { artist: @sequence.artist, default_bpm: @sequence.default_bpm, meter_bottom: @sequence.meter_bottom, meter_top: @sequence.meter_top, time: @sequence.time, title: @sequence.title }
    assert_redirected_to sequence_path(assigns(:sequence))
  end
